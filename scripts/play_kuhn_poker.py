...
from envs.kuhn_poker.env import KuhnPokerEnv,DefaultFeatureEncoder
import numpy as np
...
class HumanPlayer:
    ...
    def compute_action(self,**kwargs):
        ...
        action=input("player {}: valid actions are {}, please input your action(0-pass,1-bet):".format(obs.current_player(),valid_actions))
        action=int(action)
...
policy_0=HumanPlayer()#QLearning.load(model_path_0,env_agent_id="agent_0")
policy_1=HumanPlayer()#QLearning.load(model_path_1,env_agent_id="agent_1")

env=KuhnPokerEnv(0,None,None)
rollout_desc=RolloutDesc("agent_0",None,None,None,None)
behavior_policies={
