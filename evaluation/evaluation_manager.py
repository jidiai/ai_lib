...
class EvaluationManager:
    ...
    def eval(self):
        ...
        # update policy data
        self.policy_data_manager.update_policy_data(eval_results)
    ...
    def generate_rollout_tasks(self):
        ...
        for index_comb in zip(*indices):
            if not self.agents.share_policies or self._ordered(index_comb):
                ...
                policy_comb={agent_id:agent.policy_ids[index_comb[i]] for i,(agent_id,agent) in enumerate(self.agents.items())}
