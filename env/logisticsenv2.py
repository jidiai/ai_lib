...
class Viewer(object):
    ...
    def init_background(self):
        ...
        for i in range(self.n_vertex):
            ...
            for j in self.connections[i]:
                ...
                self._draw_road(start, end, width=5,
    ...
    def add_notation(self):
        ...
        text5 = self.font3.render(f"tips:点击图中节点/运输车辆查看详细信息", True, (44, 44, 44), (255, 255, 255))
...
class Warehouse(object):
    ...
    def draw(self, screen, color):
        ...
        pygame.draw.circle(screen, circle_fill_color, self.rect.center, self.radius, width=0)
        pygame.draw.circle(screen, circle_color, self.rect.center, self.radius, width=10)
