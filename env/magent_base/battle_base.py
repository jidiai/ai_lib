### Borrow from https://github.com/PettingZoo-Team/PettingZoo/blob/master/pettingzoo/magent/battle_v3.py   ###
### in the future, we can also set the battle env parameter, such as attach range, health points.          ###

import magent
from pettingzoo.utils.conversions import from_parallel_wrapper
from gym.utils import EzPickle
from env.magent_base.base import magent_parallel_env
import numpy as np
import math
