...
class Encoder(encoder_cls):
    def __init__(self):
        super().__init__(action_spaces=env.action_spaces['speaker_0'],
                         observation_spaces=env.observation_spaces['speaker_0'],
                         state_space=env.observation_spaces['speaker_0'])
